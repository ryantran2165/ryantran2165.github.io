  ...
  return (
    <Container id="experience" fluid={true} className="text-center pt-5 pb-5">
      ...
      <ExperienceItem
        ...
        startDate="Mar. 2018"
        endDate="Jul. 2018"
        description="At MediRev Solutions, I designed and created the company website and logo using WordPress and Adobe Illustrator. I used WordPress and some CSS instead of creating a static HTML website per the request that the website content be easily modified by non-developers. *MediRev Solutions is no longer active."
      />
      <br />
      <ExperienceItem
