...
const ProjectData = [
  ...
  },
  {
    ...
    description: [
      "Built full-stack web app with React frontend and Flask REST API backend that predicts the winner of Brazilian Jiu-Jitsu matches using deep neural networks",
