export const EXPERIENCES = [
  {
    ...
    description: [
      "Using C# to architect a database, develop ASP.NET REST APIs, and build a Blazor web app for a company-wide authentication/authorization framework that unifies the development, management, and user access control for EPRI apps and APIs",
      "Developing a Blazor web app and WPF desktop app that interfaces with an ML backend to detect nuclear fuel rod defects, improving the efficiency of nuclear fuel inspection and the safety of nuclear power plants",
